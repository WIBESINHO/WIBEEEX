...
conn.fakeReply(m.chat, `*🐢 Cargando menu, de YuGi-BOT porfavor espera.*\n\n> No hagas spam de comandos`, '0@s.whatsapp.net', 'Enviando menu de YuGi-BOT aguarden...')
...
┃📲 .instalarbot _(Tutorial de instalación)_
┃📩 .solicitud
┃💼 .cuenta 
┃💼 .cuentaoficiales
┃📊 .status 
...
├• Gestionar tu grupo con YuGi-BOT
├┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄
