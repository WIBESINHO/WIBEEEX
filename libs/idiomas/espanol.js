...
text8: `la opción para conectarse a YuGi-BOT.`, 
...
const smsWel2 = () => { return `¿COMO ESTAS Yo Soy YuGi-BOT 😎` }
const smsWel3 = () => { return `¿COMO ESTAS Yo soy YuGi-BOT 😎
😃\n\n『Bienvenido A` }
const smsWel4 = () => { return `Un gusto conocerte duelist@ 🤗\n\n_Recuerda leer las reglas del grupo para no tener ningun problema 🧐_\n\n*Solo disfrutar de este grupo y divertite 🥳*` }
...
text3: `👑 YuGi-BOT | ᴀᴄᴛɪᴠᴏ ✅️:`, 
text4: `ᴘᴀʀᴀ ᴠᴇᴢ ᴍɪ ʟɪsᴛᴀ ᴅᴇ ᴄᴏᴍᴀɴᴅᴏ ᴜsᴀʀ #menu`, 
text5: `YuGi-BOT - sᴜʙsᴄʀɪʙɪʀᴛᴇ A ɴᴜᴇsᴛʀᴏ ᴄᴀɴᴀʟ ᴅᴇʟ ʏᴏᴜᴛᴜʙᴇ 🔔\nhttps://www.youtube.com/@Eliasar_yt`, 
text6: `⏳  𝔸ℂ𝕋𝕀𝕍𝕀𝔻𝔸𝔻:`, 
text7: `👤 𝕌𝕊𝕌𝔸ℝ𝕀𝕆` }
...
const endLimit = () => { return `* EY DUELISTA 😢 NOO TIENE MAS DIAMANTE 💎*\n\nPuede comprar mas usando el comando: #buy` }
...
text13: `*ʜᴏʟᴀ ᴇsᴛɪᴍᴀᴅᴏs ᴜsᴜᴀʀɪᴏs 👋🏻, ᴛᴇ ɪɴᴠɪᴛᴏ ᴀ ᴜɴɪʀᴛᴇ ᴀ ʟᴏs ɢʀᴜᴘᴏs ᴏғɪᴄɪᴀʟᴇs ᴅᴇ ʟᴀ ғᴀᴍɪʟᴀ YuGi-BOT MD, ᴘᴀʀᴀ ᴄᴏɴᴠɪᴠɪʀ ᴄᴏɴ ʟᴀ ᴄᴏᴍᴜɴɪᴅᴀᴅ :ᴠ*\n\n*➤ ɢʀᴜᴘᴏs ᴏғɪᴄɪᴀʟᴇs ᴅᴇʟ ʙᴏᴛ:*`, 
text14: `*➤ ɢʀᴜᴘᴏ:*`, 
text15: `*➤ ɢʀᴜᴘᴏ:*`, 
text16: `*➤ ɢʀᴜᴘᴏ*`, 
text17: `*➤ ɢʀᴜᴘᴏ*`, 
...
╰┬────────────┈⊷
 │NOTA EL BOT QUE Descargaras
 │novabot si queréis a YuGi tienes que
 │al canal oficial 
...
text10: `🏆 яαηgσ:`, 
text11: `📝 яєgιѕтяα∂σ :`, 
textt: `🛡️ 𝔹𝕆𝕋 𝕆𝔽ℂ: Este es el Bot oficial`, 
texttt: `𝕤𝕠𝕪 𝕦𝕟 𝕤𝕦𝕓𝕓𝕠𝕥 𝕕𝕖 🤖 :`, 
...
//jadibot.js
const jadibot = {
text: `Escanea este QR para convertirte en un YuGi-SUBS _NOTA ESTO ES TENPORAL_

1) Haz clic en los tres puntos en la esquina superior derecha
2) Toca WhatsApp Web O DISPOSITIVOS VINCULADOS 
3) Escanea este QR
...
*𝘚𝘦𝘳𝘷𝘪𝘤𝘪𝘰 𝘱𝘳𝘰𝘷𝘦𝘪𝘥𝘰 𝘱𝘰𝘳 YuGi-BOT MD*`, 
...
views: `*Vistas:*`, 
letra: `*Letra:*`, 
music: `*• YuGi-BOT MD Esta 𝘋𝘦𝘴𝘤𝘢𝘳𝘨𝘢𝘥𝘰 𝘢𝘶𝘥𝘪𝘰 🔊, 𝘈𝘨𝘶𝘢𝘳𝘥𝘦 𝘶𝘯 𝘮𝘰𝘮𝘦𝘯𝘵𝘰....*`, 
...
text9: `*⚠️ este comando no esta disponible*`, 
...
//nsfw.js
const nsfw = {
text: `😐 Eres menor de edad! vete a jugar YuGiOh 😆`, 
...
const smsReg = () => { return `*Ya estas registrado duelista🧐*` }
...
const smsReg7 = (name, user, age, time, date, sender, sn, prefix, rtotalreg) => { return `[ ✅ YA ESTAS REGISTRADO DUELISTA]\n\n ◉ *Nombre:* ${name} ${user.registered === true ? 'ͧͧͧͦꙶͣͤ✓' : ''}\n ◉ *Edad:* ${age} años\n ◉ *Hora:* ${time}\n ◉ *Fecha:* ${date}\n ◉ *Número:* wa.me/${sender.split("@")[0]}\n ◉ *Numero del serie*\n ⤷ ${sn}\n\n 🎁 *Recompensa:*\n ⤷ 2 diamante 💎\n ⤷ 200 exp\n\n *◉ Para ver los comandos del bot usar:*
 ${prefix}menu\n\n ◉ *Total de usuários registrados:* ${rtotalreg}` }
const smsReg8 = () => { return `*💬 Elegir tu idioma con:* #idioma ejemplo en español #idioma 1` }
 
const cuenta = (nna, md, yt, tiktok, fb) => { return `*Bienvenido a las cuentas oficiales ✨*

*👑 Numero del creador de el botl:*
